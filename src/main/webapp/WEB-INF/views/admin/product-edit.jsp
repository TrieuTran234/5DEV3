...
<link rel="stylesheet" href="/admin/productedit.css" media="screen">
  ...
  <body class="u-body"><header class="u-clearfix u-header u-header" id="sec-b689"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="https://nicepage.com" class="u-image u-logo u-image-1" data-image-width="512" data-image-height="512">
          <img src="/admin/img/logo.png" class="u-logo-image u-logo-image-1">
        </a>
    ...
    <section class="u-align-center u-clearfix u-section-1" id="carousel_8dea">
      <div class="u-clearfix u-sheet u-sheet-1">
        <h2 class="u-text u-text-1">PRODUCT EDITION</h2>
        <p class="u-text u-text-2">Quản lý sản phẩm của bạn dễ dàng, tiện lợi , nhanh chóng , và theo dõi hiệu quả nội dung trên tất cả video và tối ưu hóa tiêu đề video để người dùng dễ dàng tiếp cận !</p>
        <div class="u-expanded-width u-black u-shape u-shape-rectangle u-shape-1" ></div>
                    ...
                    <div class="u-container-layout u-container-layout-1">
                      ...
                      <div class="u-video u-video-contain u-video-1">
                        <div class="embed-responsive embed-responsive-1">
                        		<form:form action="/admin/product/index" modelAttribute="item"  method="post" style="height: 800px," >
                      ...
                      <div class="u-form u-form-1">
                        <form:form action="/admin/product/index" modelAttribute="item" method="POST" enctype="multipart/form-data" class="" source="custom" name="form" style="padding: 34px; width: ;width: 550px">
                        <div class="u-form-group u-form-select u-label-none u-form-group-3">
                          ...
                          <div class="u-form-select-wrapper">
                            <form:select path="category.id" id="category" name="category"  onclick="this.form.submit" class="u-border-1 u-border-black u-input u-input-rectangle u-radius-17" >
                         ...
                         <div class="u-form-group u-form-name">
                            <label for="name-6a67" class="u-label u-label-1">Product ID</label>
                            <form:input path="id"  type="text" readonly="true" placeholder=" ID" id="name-6a67" name="id" value="${ids}" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""/>
                         </div>
                          <br>
                         <div class="u-form-group">
                            <label for="email-6a67" class="u-label u-label-2 u-text-white">Product Name</label>
                            <form:input path="name" type="text" placeholder="Enter name" id="email-6a67" name="name" value="" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required"/>
                         </div>
                          <br>
                        
                          <div class="u-form-group">
                            <label for="email-6a67" class="u-label u-label-2 u-text-white">Create Date</label>
                            <form:input path="createDate" type="text" placeholder="Enter a date"  id="email-6a67" name="createDate" value="" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required"/>
                         </div>
                          <br>
                          <div class="u-form-group">
                            <label for="message-6a67" class="u-label u-label-3">Price</label>
                            <form:input  path="price" type="number"   id="message-6a67" name="price" value="" class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required="required" />
                          </div>
                          <br>
                          <div class="u-form-group u-form-radiobutton u-form-group-4">
                            <div class="u-form-radio-button-wrapper">
                              <form:radiobutton path="available"  name="available" value="true"/>
                              <label class="u-label" for="radiobutton">Available</label>
                              <br>
                              <form:radiobutton path="available"  name="available" value="false"/>
                              ...
                              <br>
    								...
    								<label for="image" class="custom-file-label" >Image <input type="text" name="image1" value="${item.image}" readonly="true" style="border: none;"></label>
										 <input type="file" accept=".jpg,.png" class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black" id="image" name="photo"  /> 
									
									</div>
                          <br>
                          <div class="u-form-group u-form-message u-form-group-5">
                            <label for="message-106f" class="u-label u-label-6">DESCRIPTION</label>
                            <form:textarea path="" placeholder="Enter your DESCRIPTION" rows="8" cols="50" id="message-106f" name="description"  class="u-border-1 u-border-grey-30 u-input u-input-rectangle u-white" required=""></form:textarea>
                          </div>
                        
										
                          <div class="u-align-left u-form-group u-form-submit" >
                            <button class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black" style="color:black ;font-weight: bold;" formaction="/admin/product/create" >Create</button>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                            <button  class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black" style="color:black ;font-weight: bold" formaction="/admin/product/update">Update</button>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                            <button class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black" style="color:black ;font-weight: bold" formaction="/admin/product/delete/${item.id}">Delete</button>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                            <button class="u-border-none u-btn u-btn-submit u-button-style u-text-body-alt-color-black  u-btn-1 u-black" style="color:black ;font-weight: bold" formaction="/admin/product/index">New</button>
                            <input type="submit" value="submit" class="u-form-control-hidden">
                          </div>
        ...
        <div class="u-expanded-width u-gallery u-layout-horizontal u-lightbox u-no-transition u-show-text-on-hover u-gallery-1" id="carousel-7509">
          <div class="u-gallery-inner u-gallery-inner-1" role="listbox"><div class="u-effect-fade u-gallery-item u-gallery-item-1"><div class="u-back-slide" data-image-width="512" data-image-height="512"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/unnamed1.png">
...
</div><div class="u-effect-fade u-gallery-item u-gallery-item-2"><div class="u-back-slide" data-image-width="512" data-image-height="512"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/backgroundpassword1.png">
...
</div><div class="u-effect-fade u-gallery-item u-gallery-item-3"><div class="u-back-slide" data-image-width="512" data-image-height="512"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/unnamed2.png">
...
</div><div class="u-effect-fade u-gallery-item u-gallery-item-4"><div class="u-back-slide" data-image-width="286" data-image-height="286"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/unnamed5.png">
...
</div><div class="u-effect-fade u-gallery-item u-gallery-item-5"><div class="u-back-slide" data-image-width="512" data-image-height="512"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/unnamed3.png">
...
</div><div class="u-effect-fade u-gallery-item u-gallery-item-6"><div class="u-back-slide" data-image-width="286" data-image-height="286"><img class="u-back-image" src="/PS15061_TranLeHongPhuc_Assignment_SOF301_Java4/views/ADMINSTATION_TOOL/images/unnamed4.png">
...
c6.177,6.18,9.262,14.271,9.262,22.366C354.708,234.018,351.617,242.115,345.441,248.292z"></path></svg>
    ...
    <footer class="u-align-center-sm u-align-center-xs u-clearfix u-footer u-grey-80" id="sec-a58a"><div class="u-clearfix u-sheet u-sheet-1">
        <a href="https://nicepage.com" class="u-image u-logo u-image-1" data-image-width="512" data-image-height="512">
          <img src="/admin/img/logo.png" class="u-logo-image u-logo-image-1" style="width: 150px">
        </a>
