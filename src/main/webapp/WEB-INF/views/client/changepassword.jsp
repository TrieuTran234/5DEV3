...
<html lang="en">
  ...
  <body >
    ...
    <!-- Header Section End -->
         ...
         <section class="u-align-center u-clearfix u-image u-shading u-section-1" src="" data-image-width="512" data-image-height="512" id="sec-df70" style="background-image: url('/client/img/backroundsuper73.jpg');">
        ...
        <div class="u-container-style u-expanded-width-xs u-group u-palette-1-base u-group-1">
          <div class="u-container-layout u-valign-middle-xs u-container-layout-1">
            ...
            <div class="u-align-left u-expanded-width-lg u-expanded-width-md u-expanded-width-sm u-expanded-width-xs u-form u-form-1">
              <form action="/account/change" method="POST" class="" style="padding: 10px" source="custom" name="form">
                <div class="u-form-group u-form-name u-form-group-1">
                  <label for="name-5a14" class="u-form-control-hidden u-label" wfd-invisible="true">User id</label>
                  <input type="text" placeholder="Enter your Name" id="name-5a14" name="name"  value="${userid}" readonly="true" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius-26 u-white" required="" autofocus="autofocus">
                </div> <br>
                <div class="u-form-group u-form-group-2">
                  <label for="email-5a14" class="u-form-control-hidden u-label" wfd-invisible="true">Password</label>
                  <input type="password" placeholder="Enter your Password" id="email-5a14" name="password" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius-26 u-white" required="required">
                </div> <br>
                <div class="u-form-group u-form-group-3">
                  <label for="text-9def" class="u-form-control-hidden u-label"></label>
                  <input type="password" placeholder="Enter your new Password" id="text-9def" name="password1" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius-26 u-white">
                </div> <br>
                <div class="u-form-group u-form-group-4">
                  <label for="text-b2b5" class="u-form-control-hidden u-label"></label>
                  <input type="password" placeholder="Confirm new Password" id="text-b2b5" name="password2" class="u-border-2 u-border-grey-75 u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-radius-26 u-white">
                </div> <br>
                <div class="u-form-agree u-form-group u-form-group-5">
                  <input type="checkbox" id="agree-3520" name="agree" class="u-agree-checkbox" required="">
                  <label for="agree-3520" class="u-label">I Agree change my password</label>
                </div> <br>
	...
	s2.686-6,6-6s6,2.686,6,6S29.491,24,26.177,24z"></path></svg></span>
                ...
                <p class="u-text u-text-3">92/1A KHP2A, Đông Hưng Thuận, Quận 12<br>Hồ Chí Minh
                </p>
              </div>
            </div>
            <div class="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-2">
              <div class="u-container-layout u-similar-container u-container-layout-3"><span class="u-icon u-icon-circle u-icon-2"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 513.64 513.64" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-9786"></use></svg><svg class="u-svg-content" viewBox="0 0 513.64 513.64" x="0px" y="0px" id="svg-9786" style="enable-background:new 0 0 513.64 513.64;"><g><g><path d="M499.66,376.96l-71.68-71.68c-25.6-25.6-69.12-15.359-79.36,17.92c-7.68,23.041-33.28,35.841-56.32,30.72    c-51.2-12.8-120.32-79.36-133.12-133.12c-7.68-23.041,7.68-48.641,30.72-56.32c33.28-10.24,43.52-53.76,17.92-79.36l-71.68-71.68    c-20.48-17.92-51.2-17.92-69.12,0l-48.64,48.64c-48.64,51.2,5.12,186.88,125.44,307.2c120.32,120.32,256,176.641,307.2,125.44    l48.64-48.64C517.581,425.6,517.581,394.88,499.66,376.96z"></path>
                ...
                <p class="u-text u-text-5">0962463995&nbsp;<br>Mr. Phuc
                </p>
              </div>
            </div>
            ...
            <div class="u-align-center u-container-style u-list-item u-repeater-item u-white u-list-item-4">
              <div class="u-container-layout u-similar-container u-container-layout-5"><span class="u-icon u-icon-circle u-icon-4"><svg class="u-svg-link" preserveAspectRatio="xMidYMin slice" viewBox="0 0 512 512" style=""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-9f82"></use></svg><svg class="u-svg-content" viewBox="0 0 512 512" x="0px" y="0px" id="svg-9f82" style="enable-background:new 0 0 512 512;"><g><g><path d="M507.49,101.721L352.211,256L507.49,410.279c2.807-5.867,4.51-12.353,4.51-19.279V121    C512,114.073,510.297,107.588,507.49,101.721z"></path>
                ...
                <p class="u-text u-text-9">
                  <a href="mailto:hello@theme.com" class="u-active-none u-border-1 u-border-palette-2-base u-btn u-button-link u-button-style u-hover-none u-none u-text-palette-2-base u-btn-2">tranlehongphuc2001@gmail.com<br>
                  </a>
                </p>
              </div>
            </div>
